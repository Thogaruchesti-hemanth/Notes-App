...
public class TaskAdapterEnhanced extends RecyclerView.Adapter<TaskAdapterEnhanced.TaskViewHolder> {

    private List<Task> tasks;
    private OnTaskClickListener listener;
    private SimpleDateFormat timeFormat = new SimpleDateFormat("hh:mm a", Locale.getDefault());

    public TaskAdapterEnhanced(List<Task> tasks, OnTaskClickListener listener) {
        this.tasks = tasks;
    ...
    public void onBindViewHolder(@NonNull TaskViewHolder holder, int position) {
        ...
        // Set type
        holder.tvType.setText(getTypeDisplayName(task.getType()));
    ...
    static class TaskViewHolder extends RecyclerView.ViewHolder {
        CardView cardView;
        TextView tvTime, tvTitle, tvType;
